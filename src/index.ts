...
export { type BaseHydrateLifecycle, baseComponent } from './base-component.js';
export { type SignalHydrateLifecycle, signalComponent as component } from './signal-component.js';
